...
function injectGameById(gameId, options = {}) {
  ...
  function startPong(options = {}) {
    ...
    const BLUE_PADDLE_SRC = chrome.runtime.getURL("assets/blue_paddle.png");
    const RED_PADDLE_SRC = chrome.runtime.getURL("assets/red_paddle.png");
    const PONG_MENU_SRC = chrome.runtime.getURL("assets/glitch_pong_menu_FINAL.png");
    const MAIN_MENU_SRC = chrome.runtime.getURL("assets/glitch_pong_main_menu.png");
    const PAUSE_MENU_SRC = chrome.runtime.getURL("assets/pause_menu.png");
    const COUNTDOWN_3_SRC = chrome.runtime.getURL("assets/3.png");
    const COUNTDOWN_2_SRC = chrome.runtime.getURL("assets/2.png");
    const COUNTDOWN_1_SRC = chrome.runtime.getURL("assets/1.png");
    const COUNTDOWN_GO_SRC = chrome.runtime.getURL("assets/GO.png");
    ...
    const pongAudio = (() => {
      const SOUND_FILES = {
        ...
        heatLayer: "sounds/Heat Build Layer (Dynamic Music).mp3",
        clutchLayer: "sounds/High Heat (Clutch Mode Feel).mp3",
