const SHELL_CACHE = "glitch-pong-shell-v13";
const RUNTIME_CACHE = "glitch-pong-runtime-v13";
...
const SHELL_FILES = [
  ...
  "./assets/boss_eye_left.png",
  "./assets/boss_eye_right.png",
  "./assets/boss_eye_neutral.png",
  "./assets/left_eye_blink.png",
  "./assets/right_eye_blink.png",
  "./assets/straight_eye_blink.png"
];
